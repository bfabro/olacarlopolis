document.addEventListener("DOMContentLoaded", function () {
  ...
  ${
   ...
   <!-- Ícones de redes sociais e contato -->
      ...
      <!-- Botão de + Informações -->
          ...
          <div class="detalhes-content" id="detalhes-${encodeURIComponent(
            establishment.name
          )}" style="display: none;">
  ...
  <div class="banners-container swiper" id="banners-${encodeURIComponent(
      ...
      <div class="swiper-wrapper">
          ${establishment.bannerImages
            .map(
              (img, index) => `
              <div class="swiper-slide">
                  <img src="${img}" alt="Banner ${index + 1} de ${
                establishment.name
              }">
              </div>
          `
  ...
  <div class="menu-cardapio swiper" id="menu-${encodeURIComponent(
      ...
      <div class="swiper-wrapper">
          ${establishment.menuImages
            .map(
              (img, index) => `
              <div class="swiper-slide">
                  <img src="${img}" alt="Cardápio ${index + 1} de ${
                establishment.name
              }">
              </div>
          `
           ...
           : ""
                ...
                ${
                  establishment.menuFlyer
                    ? `
               <!-- <button class="flyer-btn" data-name="${
                 establishment.name
               }" style=" #dfa529; color: white; border: none; padding: 5px 10px; border-radius: 5px; cursor: pointer;">
                  Ver Flyer
                </button>-->
                <div class="menu-content" id="menu-${encodeURIComponent(
                  establishment.name
                )}" style="display: none; text-align: center;">
                  <img src="${establishment.menuFlyer}" alt="Flyer de ${
                        establishment.name
                      }" style="width: 100%; max-width: 400px; border-radius: 10px; margin-top: 10px;">
                </div>`
                    : ""
                }
...
function closeAllContents() {
    ...
    document
      ...
      document
        .querySelectorAll(
          ".fechar-menu, .fechar-flyer, .fechar-detalhes, .fechar-banner"
        )
        .forEach((button) => {
          button.addEventListener("click", function () {
